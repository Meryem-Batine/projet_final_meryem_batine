...
{{-- original --}}
                                <form id="sort-form" method="GET" action="{{ route('shop.sort') }}" class="single_product_menu d-flex">
                                    <h5>short by : </h5>
                                    <select name="slct" id="sort-by">
                                        <option data-display="Select" value="product">product</option>
                                        <option value="name_asc">name</option> <!-- Tri ascendant par nom -->
                    ...
                    <div class="row align-items-center latest_product_inner">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_product_item ">
                                <img src="{{ asset('storage/img/photo/' . $product->image) }}" style="height: 300px" alt="">

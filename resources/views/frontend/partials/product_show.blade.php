        ...
        <div class="container">
            <div class="row s_product_inner justify-content-between">
                <div class="col-lg-7 col-xl-7">
                    <div class="product_slider_img">
                        <div id="vertical">
                            <div data-thumb="{{asset('storage/img/photo/' . $product->image)}}">
                                <img src="{{asset('storage/img/photo/' . $product->image)}}" />
                            </div>
                            <div data-thumb="{{asset('storage/img/photo/' . $product->image)}}">
                                <img src="{{asset('storage/img/photo/' . $product->image)}}" />
                            </div>
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            <li>
                                <a class="active" href="#">
                                    <span>Category</span> : {{$product->categorie_id}}</a>
                            </li>
                            <li>
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            {{-- <img src="{{ asset('/img/product/single-product/review-3.png') }}" alt="Image">                    </div> --}}
